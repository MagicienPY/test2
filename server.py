...
def errorDialog(msg):
	...
	diag = QtGui.QMessageBox(QtGui.QMessageBox.Warning, 'Erreur dans la  macro du  MessageBox', msg)
		...
		if (freeCadCommandToRun[0:6] == "python"):
			...
			with stdoutIO() as s:
				try:
					...
					print("Quel que chose ne marche pas avec l'instruction")
			...
			try:
				...
				myReturnMSG = "####ERROR, quelque chose ne marche pas bien : " + blablablabla
				print(myReturnMSG )
